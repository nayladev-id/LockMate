...
/// lockmateApp — root widget yang membungkus [MaterialApp].
///
...
class LockMateApp extends StatefulWidget {
  const LockMateApp({super.key});

  @override
  State<LockMateApp> createState() => _lockmateAppState();
}

class _lockmateAppState extends State<LockMateApp> {
  @override
  void initState() {
    super.initState();
